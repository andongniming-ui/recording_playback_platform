...
EXPECTED_DIDI_START_SCRIPT = "/home/recording_playback_platform/systems-under-test/didi/didi-system-a/start.sh"
    ...
    def test_prefers_running_process_cwd(self):
        ...
        def fake_run(app_, cmd, timeout=30):
            if "readlink -f /proc/4321/cwd" in cmd:
                return (0, EXPECTED_DIDI_START_SCRIPT, "")
            if "find ~" in cmd or "ls ~" in cmd:
        ...
        assert script == EXPECTED_DIDI_START_SCRIPT
