...
public class XmlPayloadService {
    ...
    public GatewayContext parse(String xml) {
        try {
            ...
            context.setTraId(firstNonBlank(textOf(document, "tra_id"), textOf(document, "traId"), generateTraId()));
    ...
    public String buildResponseXml(GatewayContext context,
        ...
        append(builder, "tra_id", context.getTraId());
