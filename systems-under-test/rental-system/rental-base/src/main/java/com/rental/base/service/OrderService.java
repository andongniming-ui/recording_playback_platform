...
import com.rental.base.mapper.UserMapper;
...
public class OrderService {
    ...
    public OrderBody.OrderRes create(OrderBody.CreateReq req) {
        ...
        BigDecimal deposit = estimatedFee.multiply(new BigDecimal("0.20")); // Base: 20% deposit
    ...
    public OrderBody.OrderRes complete(OrderBody.CompleteReq req) {
        ...
        BigDecimal lateFeePerDay = new BigDecimal("50.00");
    ...
    public OrderBody.OrderRes extend(OrderBody.ExtendReq req) {
        ...
        BigDecimal newDeposit = newEstimatedFee.multiply(new BigDecimal("0.20"));
