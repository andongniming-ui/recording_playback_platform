...
public class VehicleService {
    ...
    public VehicleBody.VehicleRes query(VehicleBody.QueryReq req) {
        ...
        // COMPARE: Build extra maintenance detail info not present in base
        String extraInfo = "{\"next_maintenance_date\":\"2026-07-15\",\"last_maintenance_date\":\"2026-01-10\"}";
        return toVehicleRes(v, extraInfo);
    }
