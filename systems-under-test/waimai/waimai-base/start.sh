...
JAR_PATH="target/waimai-base-1.0.0-SNAPSHOT.jar"
LOG_PATH="${SCRIPT_DIR}/waimai-base.log"
...
echo "Starting waimai-base on port 19091..."
setsid nohup java \
  -javaagent:"$AREX_AGENT_JAR_PATH" \
  -Darex.service.name=waimai-base \
